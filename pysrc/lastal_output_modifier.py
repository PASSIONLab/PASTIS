...
def main():
    overlaps_fname = '/Users/esaliya/sali/git/github/esaliya/cpp/lbl.pastis/pysrc/data/cori/scope/mmseqs2.shuff/filtered.gt30pid.gt70lencov.scope.77k.shuff.mmseqs2.out.txt'

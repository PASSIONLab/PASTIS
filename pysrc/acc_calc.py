...
def main():
    overlaps_fname = '/Users/esaliya/sali/git/github/esaliya/cpp/lbl.pastis/pysrc/data/cori/scope/pastis/with_sub/k6/subs100/ba5_shuff/ba5_shuff_subs100_align.txt'
    ...
    if align or is_LAST:
        gen_hists(pids_A, pids_B, pids_C, pids_A_hist, pids_B_hist,
                  pids_C_hist, "PASTIS" if align else "LAST")
